...
begin
  ...
  begin
          ...
          with frmVenda do begin
            ...
            begin
              ...
              begin
                ...
                frmTef.cpPosPrinter.BUFFER.Add('Autorização: '+ret.CodigoAutorizacao);
    ...
    Else
      Application.MessageBox('Operação não conluída!', 'Atenção!', MB_ICONINFORMATION);
  end;
  //ActionList1.State := asNormal;
end;
...
begin
  if Recebido > 0 then begin
    Application.MessageBox('Não é permitido lançar Acréscimo após lançamento de recebimento!', 'Atenção!', MB_ICONINFORMATION);
    Exit;
  end;
