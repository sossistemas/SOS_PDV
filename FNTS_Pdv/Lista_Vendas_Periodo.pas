...
uses modulo, principal, funcoes, unSintegra, msg_Operador;
...
begin
 if retorno = -1 then
 // showmessage('Erro na chamada da função! Verifique o erro em C:\SOS\paf\Log_Erro.txt')
 else
 if retorno = 0 then
...
begin
  ...
  begin
    ...
    sArquivoSintegra := sPasta_sistema+'\txt\'+copy(Datetostr(Date),1,2)+
