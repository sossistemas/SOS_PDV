object frmxloc_produto: Tfrmxloc_produto
  ...
  object query: TUniQuery
    ...
    object queryATIVA: TStringField
      FieldName = 'ATIVA'
      Size = 10
    end
    object queryCEST: TStringField
      FieldName = 'CEST'
      Required = True
      Size = 7
    end
    ...
    object queryIND_CFOP_NFCE: TStringField
    ...
    object queryNAO_MOVIMENTA_ESTOQUE: TStringField
      FieldName = 'NAO_MOVIMENTA_ESTOQUE'
      Size = 1
    end
    object queryPESAGEM_AUOTMATICA: TStringField
      FieldName = 'PESAGEM_AUOTMATICA'
      Size = 1
    end
    object queryINFORMA_CODIGO_BARRA_XML: TStringField
      FieldName = 'INFORMA_CODIGO_BARRA_XML'
      Size = 1
    end
    object queryCODIGO_ANP: TStringField
      FieldName = 'CODIGO_ANP'
      Size = 10
    end
    object queryCOMBO: TStringField
      FieldName = 'COMBO'
      Size = 1
    end
    object queryIND_CFOP_DEV_COMPRA_DENTRO: TStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_DENTRO'
      Size = 6
    end
    object queryIND_CFOP_DEV_COMPRA_FORA: TStringField
      FieldName = 'IND_CFOP_DEV_COMPRA_FORA'
      Size = 6
    end
    object queryPIZZA: TStringField
      FieldName = 'PIZZA'
      Size = 1
    end
    ...
    object queryECF_ICMS: TStringField
      FieldName = 'ECF_ICMS'
      Size = 30
    end
  end
