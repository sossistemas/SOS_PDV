...
type
  TfrmBandeira = class(TForm)
    ...
    qrBancoCNPJ_ADMINISTRADORA: TStringField;
    qrBancoCOD_ADM_CARTAO_SAT: TStringField;
...
begin
  ...
  with frmBandeira do begin
    ...
    if Continua then begin
      ...
      Result.cnpj := qrBancoCNPJ_ADMINISTRADORA.AsString;
      Result.cod_adm_sat := qrBancoCOD_ADM_CARTAO_SAT.AsString;
    end else begin
