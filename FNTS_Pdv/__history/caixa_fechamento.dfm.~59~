object frmCaixa_Fechamento: TfrmCaixa_Fechamento
  ...
  object PageControl1: TPageControl
    ...
    object TabFechamento: TTabSheet
      ...
      object pnlAlertaSemRegistroFechamento: TPanel
        Left = 0
        Top = 0
        Width = 668
        Height = 372
        Align = alClient
        Caption = '<Nenhum fechamento registrado nesta data>'
        TabOrder = 1
        Visible = False
      end
    end
  ...
  object ed_data: TJvDateEdit
    ...
    ShowNullDate = False
    TabOrder = 0
    OnAcceptDate = ed_dataAcceptDate
  ...
  object fxFechamento: TfrxReport
    ...
    ReportOptions.LastChange = 44173.802442615740000000
    ...
    ScriptText.Strings = (
      ...
      ''
      'end.')
    OnBeforePrint = fxFechamentoBeforePrint
    Left = 312
    Top = 408
    Datasets = <
      item
