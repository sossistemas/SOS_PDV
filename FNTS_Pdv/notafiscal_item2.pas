...
uses
  ...
  Dialogs, ExtCtrls, DB, DBAccess, Menus, RzBtnEdt, StdCtrls,
  RzEdit, Mask, AdvGlowButton, TFlatPanelUnit, Uni, MemDS;
type
 ...
 //   dsgrade: TIBCDataSource;
  ...
  //  query1: TIBCQuery;
    ...
    qrgrade: TUniQuery;
    query1: TUniQuery;
    dsgrade: TUniDataSource;
    dsserial: TUniDataSource;
...
//    FrmNota{ TODO 1 -oMizael -cBlob : Resolver }Fiscal.qrnotafiscal_item.Params.Parambyname('COMPLEMENTO'         ).AsBlob := ED_COMPLEMENTO.Lines.Text;
