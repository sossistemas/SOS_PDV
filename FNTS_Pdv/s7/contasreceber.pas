...
uses
  ...
  Dialogs, Grids, frxRich, DBAccess, VirtualTable, CRBatchMove,
  DB, frxClass, frxDBSet, frxDesgn, Menus, ImgList, StdCtrls,
  DBCtrls, ExtCtrls, Collection, AdvGlowButton, TFlatPanelUnit, Wwdbigrd, Wwdbgrid, PageView, Mask, RzEdit, RzBtnEdt,
  Uni, System.ImageList, JvMemoryDataset, JvExMask, JvToolEdit, JvBaseEdits,
  MemDS;
...
//    qrservicoCODCLIENTE: TStringField;
 ...
 {   qrproduto_movCODPRODUTO: TStringField;
    ...
    qrfunci: TUniQuery;
    qrcontasreceber_pgto: TUniQuery;
    qrservico: TUniQuery;
    qrcontasreceber: TUniQuery;
    qrbanco: TUniQuery;
    qrconfig_cobrebem: TUniQuery;
    ...
    qrproduto_movPRODUTO_1: TStringField;
    ...
    qrconfig_cobrebemCODIGO_CARTEIRA: TStringField;
    qrconfig_cobrebemFORMA_CADASTRAMENTO: TStringField;
    qrconfig_cobrebemCONTADIG: TStringField;
    qrconfig_cobrebemAGENCIADIG: TStringField;
    qrconfig_cobrebemCONVENIO: TStringField;
    qrconfig_cobrebemCNPJ: TStringField;
    qrconfig_cobrebemCODCONTADIG: TStringField;
    qrcontacorrenteCODIGO: TStringField;
    qrcontacorrenteCONTA: TStringField;
    qrcontacorrenteCODBANCO: TStringField;
    qrcontacorrenteAGENCIA: TStringField;
    ...
    zQuery1CODVENDA: TStringField;
    zQuery1CODVENDEDOR: TStringField;
    zQuery1CODCAIXA: TStringField;
    zQuery1CODCLIENTE: TStringField;
    zQuery1DATA_EMISSAO: TDateTimeField;
    zQuery1DATA_VENCIMENTO: TDateTimeField;
    zQuery1DATA_PAGAMENTO: TDateTimeField;
    zQuery1VALOR_ORIGINAL: TFloatField;
    zQuery1VALOR_PAGO: TFloatField;
    zQuery1VALOR_JUROS: TFloatField;
    zQuery1VALOR_ATUAL: TFloatField;
    zQuery1VALOR_DESCONTO: TFloatField;
    zQuery1DOCUMENTO: TStringField;
    zQuery1TIPO: TStringField;
    zQuery1SITUACAO: TIntegerField;
    zQuery1FILTRO: TIntegerField;
    zQuery1NOSSONUMERO: TStringField;
    zQuery1CODREGIAO: TStringField;
    zQuery1CODCEDENTE: TStringField;
    zQuery1P5: TFloatField;
    zQuery1P3: TFloatField;
    zQuery1NUMERO_CUPOM: TStringField;
    zQuery1VALOR_VENDA: TFloatField;
    zQuery1COD_VENDA_ORIGINAL: TStringField;
    zQuery1VALOR_ATUAL_ANTERIOR: TFloatField;
    zQuery1EMAIL_ENVIADO: TIntegerField;
    zQuery1HISTORICO: TStringField;
    qrvendaCODIGO: TStringField;
    qrvendaCUPOM_FISCAL: TIntegerField;
    qrvendaTOTAL: TFloatField;
...
begin
  ...
  frmmodulo.qrcaixa_operador.Locate('codigo',Zerar(inttostr(iNumCaixa),6),[loCaseInsensitive]);
...
begin
{
  ...
  frmmodulo.qrcaixa_operador.Open;
  frmmodulo.qrcaixa_operador.Locate('codigo','0000 9 9',[loCaseInsensitive]);
